...
public class TalkToNPC : MonoBehaviour
{
    ...
    void CreateFile(ref string playerFileName)
    {
        ...
        playerFileName = path;
            ...
            File.AppendAllText(path, "\t-Interview Prep_________________________: NO\n");
            File.AppendAllText(path, "\t-Networking_____________________________: NO\n");
            File.AppendAllText(path, "\t-Personal Branding______________________: NO\n");
            File.AppendAllText(path, "\t-Star___________________________________: NO\n");
            File.AppendAllText(path, "\t-Survive Adapt and Florish______________: NO\n");
            File.AppendAllText(path, "\t-Sweet Spot_____________________________: NO\n");
            File.AppendAllText(path, "\t-Value__________________________________: NO\n");
            File.AppendAllText(path, "\n");
            ...
            File.AppendAllText(path, "\t-STAR___________________________________:NO\n");
            File.AppendAllText(path, "\t-Question 1_____________________________:0%\n");
            File.AppendAllText(path, "\t-Question 2_____________________________:0%\n");
            File.AppendAllText(path, "\t-Question 3_____________________________:0%\n");
            File.AppendAllText(path, "\t-Question 4_____________________________:0%\n");
            File.AppendAllText(path, "\t-Question 5_____________________________:0%\n");
            File.AppendAllText(path, "\t-Progress Bar_________________[******    ]\n");
            File.AppendAllText(path, "\n");
            ...
            File.AppendAllText(path, "\t-Question 4_____________________________:0%\n");
            File.AppendAllText(path, "\t-Question 5_____________________________:0%\n");
            File.AppendAllText(path, "    -Progress Bar_______________[**********]\n");
            File.AppendAllText(path, "\n");
