...
public class TalkToNPC : MonoBehaviour
{
    ...
    void CreateFile(ref string playerFileName)
    {
        ...
        File.AppendAllText(path, "\t-What to Say (and How to Say It!________: NO\n");
        File.AppendAllText(path, "\t-Brain Teasers__________________________: NO\n");
        File.AppendAllText(path, "\t-Team Synergy___________________________: NO\n");
        File.AppendAllText(path, "\t-Hiring Manager's Guide to Everything___: NO\n");
        File.AppendAllText(path, "\t-Principles of Management_______________: NO\n");
        File.AppendAllText(path, "\t-Employment Laws________________________: NO\n");
        File.AppendAllText(path, "\t-CompTia A+ Certification Prep Questions: NO\n");
        File.AppendAllText(path, "\t-Intro to Hardware______________________: NO\n");
        File.AppendAllText(path, "\t-Troubleshooting 101____________________: NO\n");
        File.AppendAllText(path, "\t-Guide to Networking____________________: NO\n");
        File.AppendAllText(path, "\t-How to Be a Better Leader______________: NO\n");
        File.AppendAllText(path, "\t-Into to Python_________________________: NO\n");
        File.AppendAllText(path, "\t-Software Engineering Principles________: NO\n");
        File.AppendAllText(path, "\t-Debugging 101__________________________: NO\n");
        File.AppendAllText(path, "\t-Game Design____________________________: NO\n");
        File.AppendAllText(path, "\t-Working in a Team______________________: NO\n");
        File.AppendAllText(path, "\t-Microswift Office for Dummies__________: NO\n");
        File.AppendAllText(path, "\t-Principles of Engineering______________: NO\n");
        File.AppendAllText(path, "\t-I Inc., Career Planning and Personal___: NO\n");
        File.AppendAllText(path, "\t-Entrepreneurship_______________________: NO\n");
        File.AppendAllText(path, "\t-Tiger in the Office____________________: NO\n");
        File.AppendAllText(path, "\n");
